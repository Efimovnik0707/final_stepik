...
class ProductPage(BasePage):
    ...
    def should_be_same_price(self):
        self.text_price = self.browser.find_element(
            *ProductPageLocators.PRICE_TEXT)
        self.cart_price = self.browser.find_element(
    ...
    def should_be_same_item_name(self):
        self.text_cart = self.browser.find_element(
            *ProductPageLocators.CART_TEXT)
        self.cart_name = self.browser.find_element(
            *ProductPageLocators.CART_NAME)
